    ...
    return (
        <nav>
            <div className="web-logo">
                <NavLink to="/" ><img className="nav-logo" src="kunsh-logo.svg" alt="Kunsh Masale" /></NavLink>
                {/* <img className='nav-logo' src="kunsh-logo.svg" alt="" /> */}
            </div>
            <ul className='nav-links' >
                <NavLink className={({isActive}) => isActive ? 'active' : ''} to='/' ><li>Home</li></NavLink>
                <NavLink className={({isActive}) => isActive ? 'active' : ''} to='/about-us' ><li>About</li></NavLink>
                <NavLink className={({isActive}) => isActive ? 'active' : ''} to='/products' ><li>Products</li></NavLink>
                <NavLink className={({isActive}) => isActive ? 'active' : ''} to='/product-details' ><li>Product Details</li></NavLink>
                <NavLink className={({isActive}) => isActive ? 'active' : ''} to='/history' ><li>History</li></NavLink>
                <NavLink className={({isActive}) => isActive ? 'active' : ''} to='/contact-us' ><li>Contact Us</li></NavLink>
            </ul>
